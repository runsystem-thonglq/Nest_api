...
export default (): Config => {
  ...
  return {
    app: {
      ...
      clientAppUrl:
        process.env.CLIENT_APP_URL || "https://iccou.tvcm-kousa.or.jp",
      faqUrl: process.env.FAQ_URL || "https://www.tvcm-kousa.or.jp/faq",
      mainWebsiteUrl: "https://www.tvcm-kousa.or.jp",
    },
    database: {
      type: "postgres",
      database:
